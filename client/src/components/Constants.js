export default {
    // If IMAGE_PATH changes, need to manually change default stories img tags in backend/outputs. 
    // Instead of local files in unsplash25k/sketch_images1024/ use URL
    IMAGE_PATH: "unsplash/",
